...
/// The original stock-count reports (Final Products + Materials & Consumables),
/// preserved as a two-tab screen. Opened from the reports hub. [initialTab] is
/// 0 for Final Products, 1 for Materials.
class StockReportsScreen extends ConsumerStatefulWidget {
  final int initialTab;
  const StockReportsScreen({super.key, this.initialTab = 0});
